...
def get_energy(q, pos, species):
    ...
    # Define a function for the Nbb == 3 case
    def trimer_case(_):
        return trimer_energy(q, pos, species)

    # Define a function for the Nbb == 2 case
    def dimer_case(_):
        return dimer_energy(q, pos, species)

    # Use lax.cond to conditionally execute the correct function
    energy = lax.cond(Nbb == 3, trimer_case, dimer_case, None)
...
target_species = [1,0,2,3,0,4,4,0,3] 
print(trimer_energy(trimer_rb, trimer_shapes, target_species))
print(get_zrot(trimer_energy, trimer_rb, trimer_shapes, target_species))   
